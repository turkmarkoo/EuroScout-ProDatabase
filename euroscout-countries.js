/* One country identity for imported records, user edits, filters and flags. */
(function(){
...
const names=new Intl.DisplayNames(['en'],{type:'region'}),byName=new Map(),byCode={};
const norm=s=>String(s||'').normalize('NFD').replace(/[\u0300-\u036f]/g,'').toLowerCase().replace(/ı/g,'i').replace(/[^a-z0-9]/g,'');
