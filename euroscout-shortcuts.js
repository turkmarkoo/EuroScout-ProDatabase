...
K.configure({app:'euroscout',account,
...
const free=()=>!document.querySelector('#modal,#sxMask,#mtscMask,#tpOverlay');
...
if(typeof esSettings==='function'){const base=esSettings;esSettings=function(){base();const box=document.querySelector('#esSettingsActions');if(box&&typeof esButton==='function')box.appendChild(esButton('Keyboard shortcuts',()=>{hideModal();K.openSettings();}));};
